...
%left PLUS MINUS; // plus and minus
%left TIMES DIVIDE;
...
ifThenElseExpr: IF expr THEN expr { $$ = new IfThenElse(@1, $2, $4, new Sequence(nl, std::vector< Expr *>())); }
...
seqExpr : LPAREN exprs RPAREN { $$ = new Sequence(@1, std::vector<Expr*>($2)); }
;
